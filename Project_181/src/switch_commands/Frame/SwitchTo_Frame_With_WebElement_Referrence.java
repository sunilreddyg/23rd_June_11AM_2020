...
public class SwitchTo_Frame_With_WebElement_Referrence {
	...
	public static void main(String[] args) 
	{
		...
		WebElement Modal_Frame=driver.findElement(By.xpath("/html[1]/body[1]/div[2]/section[1]/section[2]/section[1]/section[1]/iframe[1]"));
